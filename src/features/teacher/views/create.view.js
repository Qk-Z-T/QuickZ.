// src/features/teacher/views/create.view.js
// পরীক্ষা তৈরি — ম্যানুয়াল ও JSON মোড সঠিকভাবে টগল হয়
...
import { autoResizeTextarea } from '../../../core/utils/math-helper.js';
...
export function renderCreate(container) {
    ...
    // initial
    window.switchQuestionMode('manual');
...
// গ্লোবাল ফাংশন (কম্পোনেন্ট থেকে কল করার জন্য)
